...
void gen_ldpc_files (char *codefile, char* occupiedfile, char* fadefile, char *cyclefile, int filenum,
...
// read B, E, D
void ldpc_rd_phck(char *, mod2sparse *B, mod2sparse *E, mod2sparse *D);

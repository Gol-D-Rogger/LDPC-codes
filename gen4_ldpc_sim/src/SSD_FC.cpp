...
void read_config_file()
{
    ...
    // generate pchk file
    sprintf(pchk_file, "./matrix/LDPC_%dx%dex%d_w%d_dense%d_QC_H.txt", h_m, h_n, h_sc, h_wt, h_dense);
    sprintf(drop_file, "./matrix/LDPC_%dx%dex%d_w%d_dense%d_drop_col.txt", h_m, h_n, h_sc, h_wt, h_dense);
